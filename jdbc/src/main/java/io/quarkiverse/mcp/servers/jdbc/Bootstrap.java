 ...
 * No Quarkus is available here, this is a pure java application.
 */
@Command(name = "mcp-server-jdbc", mixinStandardHelpOptions = true, version = "1.0", description = """
        ...
        """)
class Bootstrap implements Callable<Integer> {
    ...
    /**
     * Calculates the mcp server alias based on the implementation version.
     * If no version is found, it will use the latest RELEASE version.
     *
     * @return
     */
    String getMcpServerAlias() {
        ...
        if (mcpServer == null) {
            ...
            mcpServer = "io.quarkiverse.mcp.servers:mcp-server-jfx:" + version + "@fatjar";
        }
        return mcpServer;
    }
